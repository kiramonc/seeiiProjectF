...
public class BeanRConcepto {
    ...
    public void registrar() {
        ...
        try {
            ...
            List<Estudiante> lstEstudiantes = daoEstudiante.verPorUnidadEnsenianza(session, "Unidad Básica"); // posteriormente cambiar la Unidad por la Unidad a la q pertenece
    ...
    public void importarConceptos() {
        ...
        try {
            ...
            while ((userMap = mapReader.read(header, processors)) != null) {
                ...
                lstEstudiantes = daoEstudiante.verPorUnidadEnsenianza(session, "Unidad Básica"); // posteriormente cambiar la Unidad por la Unidad a la q pertenece
