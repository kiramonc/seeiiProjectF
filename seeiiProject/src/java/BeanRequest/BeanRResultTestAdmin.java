...
public class BeanRResultTestAdmin {
    ...
    public void inferenciaRed(Estudiante e) {
        ...
        try {
            ...
            this.valorUnidad= (Util.roundedString(Double.parseDouble(valueInf.get(unidadE.getNombreUnidad()))*100.00, "0.001"))+"%";
    ...
    public List<Estudiante> getListaEstudiantesPorUnidad() {
        ...
        try {
            ...
            this.listaEstudiantesPorUnidad = daoEstudiante.verPorUnidadEnsenianza(session, unidadE.getNombreUnidad());
